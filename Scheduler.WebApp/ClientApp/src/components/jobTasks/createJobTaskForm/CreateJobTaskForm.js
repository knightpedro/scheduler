...
import { BaseForm, FormGroup, FormikSelect, FormikDateTime } from '../../common/forms';
...
const validationSchema = yup.object().shape({
    ...
    selectedResources: yup.array()
        .label("Selected plant")
        .nullable()
        .test("oneOfRequired", "You must assign staff and/or plant to the task", function(value) {
...
const CreateJobTaskForm = ({ handleSubmit, handleCancel, workers, resources, jobTask=null }) => {
    return (
        <BaseForm
        ...
        >
            ...
            <FormGroup name="selectedWorkers" label="Assign Staff" component={FormikSelect} options={workers} isSearchable isMulti closeMenuOnSelect={false} />
            <FormGroup name="selectedResources" label="Assign Plant" component={FormikSelect} options={resources} isSearchable isMulti closeMenuOnSelect={false} />
        </BaseForm>
    )
}
